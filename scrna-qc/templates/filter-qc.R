...
sample_list <- list()
qc_stats <- data.frame(Sample=character(), Cells_Before=integer(), Cells_After=integer(),
                       Min_Features=numeric(), Max_Features=numeric(), Max_MT=numeric(), stringsAsFactors=FALSE)
nFeature_plots <- list()
nCount_plots <- list()
mt_plots <- list()
